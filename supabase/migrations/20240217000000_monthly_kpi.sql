...
create table dna_kpi.monthly_kpi (
  ...
  val_actual_daily numeric default null,
  val_actual_monthly numeric default null,
  val_target_daily numeric default null,
  val_target_monthly numeric default null,
